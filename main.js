...
function showPosition(position) {
    ...
    marcas2 = L.marker([3.5140129, -76.2999147], {
            icon: redicon
        }).addTo(map)
        .bindPopup('<img src="icon.png" width="100"/>FitBox<a href=\"https://www.instagram.com/fitboxgympalmira/" target=\"_blank\" title=\"Opens in a new window\">Visitar</a>');



    marcas1 = L.marker([3.5339758, -76.2918374], {
            icon: redicon
        }).addTo(map)
        .bindPopup('<img src="icon.png" width="100"/>FitBox<a href=\"https://www.instagram.com/fitboxgympalmira/" target=\"_blank\" title=\"Opens in a new window\">Visitar</a>');

    marcas3 = L.marker([3.5260129, -76.3084008], {
            icon: redicon
        }).addTo(map)
        .bindPopup('<img src="icon.png" width="100"/>FitBox<a href=\"https://www.instagram.com/fitboxgympalmira/" target=\"_blank\" title=\"Opens in a new window\">Visitar</a>');

    marcas4 = L.marker([3.5460129, -76.3084008], {
            icon: redicon
        }).addTo(map)
        .bindPopup('<img src="icon.png" width="100"/>FitBox<a href=\"https://www.instagram.com/fitboxgympalmira/" target=\"_blank\" title=\"Opens in a new window\">Visitar</a>');
